...
- (void)viewDidLoad {
    ...
    /**
     *  自定义barButtonItem之后,解决push不响应系统手势的问题
     */
...
//声明一个创建上导航的右侧按钮
- (void)createRightNavigationBarButtonWithTitle:(NSString *)title image:(NSString *) image target:(id)target action:(SEL)selector {
    ...
    [right setImage:[UIImage imageNamed:image]];
